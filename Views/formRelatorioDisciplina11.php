                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            $listaDisciplina = new conexao("tipo_disciplina");
                            $disciplinas = $listaDisciplina->listaDisciplinas();
                            foreach($disciplinas as $linha){
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                        ...
                                        <a href="formRelatórioDisciplina.php?codigo=<?php echo $linha['codigo'] ?>">
                                            <button type="button" class="btn btn-outline btn-default" title="Alterar Registro">
                                                Visualizar
                                            </button>
                                        </a>

                                        <a href="./Controller/disciplina.php?codigo=<?php echo $linha['codigo'] ?>"> <button type="button" class="btn btn-outline btn-default" title="Alterar Registro">
                                                Inativar
