...
<div class="container">
  <?php
      if (isset($_GET["codigo"])){
        ...
        $codigo = $_GET["codigo"];
        $buscarCurso = new conexao("curso");
        $retornoCurso = $buscarCurso->listaUm($codigo);
        foreach($retornoCurso as $linha)
        ?>
        ...
        <div class="col-md-10 col-md-offset-4">
            <div class="login-panel panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Cadastro do Curso</h3>
                </div>
                <div class="panel-body">

                    <form action="./Controller/cadastroCurso.php" method="post" role="form">
                        <fieldset>
                            <div class="form-group">
                                <label>Text Input</label>
                                <input class="form-control" type="text" name="descricao" value="<?php echo $linha['descricao']; ?>">
                                 <input class="form-control" type="text" name="descricao" value="<?php echo $linha['carga_horaria']; ?>">
                                 <input class="form-control" type="text" name="descricao" value="<?php echo $linha['cod_usuario_coordenador']; ?>">
                            </div>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        Registro dos Tipos de Usuários
                            ...
                            foreach($curso as $linha){
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><?php echo $linha['nome'] ?></td>
                                       ...
                                       <!-- <a href="formsCadastroCurso.php?codigo=<?php echo $linha['codigo'] ?>">
