...
class Turma{
    ...
    public function cadastrar($descricao, $cod_curso, $ano, $cod_periodo, $cod_serie){
      ...
      $sql="insert into turma (descricao, cod_curso, ano, cod_periodo, cod_serie) values 
    ...
    public function alterar($cod_turma, $descricao, $cod_curso,$ano, $cod_periodo,$cod_serie){
