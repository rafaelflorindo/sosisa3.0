...
class Curso{
    ...
    public function alterar($cod_curso, $descricao, $cargaHoraria, $codUsuarioCoordenador){
      ...
      $sql="alter table curso descricao='$this->descricao', cargaHoraria='$this->cargaHoraria', codUsuarioCoordenador ='$this->codUsuarioCoordenador' where cod_curso ='$this->cod_curso'";
    ...
    public function listaCursoSelect(){
